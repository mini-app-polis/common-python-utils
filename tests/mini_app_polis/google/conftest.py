...
def pytest_configure():
    """Provide stubs for `mini_app_polis.*` and Google client libs.

    The package under test imports `mini_app_polis.logger`, `mini_app_polis.config`, and several
    ...
    # ------------------------------------------------------------------
    # mini_app_polis stubs (DO NOT overwrite the real `mini_app_polis` package)
    # ------------------------------------------------------------------
    mini_app_polis_logger = types.ModuleType("mini_app_polis.logger")
    mini_app_polis_config = types.ModuleType("mini_app_polis.config")
    ...
    mini_app_polis_logger.get_logger = get_logger  # type: ignore[attr-defined]
    # Some modules use `from mini_app_polis import logger as log` and then call
    # `log.warning(...)` directly. Provide those module-level shims.
    mini_app_polis_logger.info = _logger.info  # type: ignore[attr-defined]
    mini_app_polis_logger.warning = _logger.warning  # type: ignore[attr-defined]
    ...
    _install_stub_module("mini_app_polis.logger", mini_app_polis_logger)
    _install_stub_module("mini_app_polis.config", mini_app_polis_config)
