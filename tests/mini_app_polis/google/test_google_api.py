def test_google_api_from_env_builds_facades(monkeypatch):
    ...
    monkeypatch.setattr(
        "mini_app_polis.google.google.load_credentials", lambda _auth: object()
    )
    monkeypatch.setattr(
        "mini_app_polis.google.google.build_sheets_service", lambda _c: "sheets"
    )
    monkeypatch.setattr(
        "mini_app_polis.google.google.build_drive_service", lambda _c: "drive"
    )
    monkeypatch.setattr(
        "mini_app_polis.google.google.build_gspread_client", lambda _c: "gspread"
    )
